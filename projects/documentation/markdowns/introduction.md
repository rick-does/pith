...
This documentation is itself a PiTH project — managed in PiTH and bundled with the app. If you're running PiTH locally, you can open the documentation project directly in the app to read or edit any page.
